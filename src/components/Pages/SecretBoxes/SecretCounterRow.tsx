...
export const SecretCounterRow = () => {
  return (
    <section className="flex items-center justify-between">
      <div className="flex flex-col">
        <h1 className="mb-6 text-6xl font-display dark:text-primary">Secret Counter</h1>
      ...
      <div>
        <SecretCounterLottie style={{ width: '384px', height: '248px' }} />
      </div>
    </section>
  )
}
